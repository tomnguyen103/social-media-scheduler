...
export default function AccountsError({
  ...
  useEffect(() => {
    console.error("Accounts error caught by boundary:", error);
  }, [error]);
  ...
  return (
    <div className="flex min-h-[400px] flex-col items-center justify-center p-6 text-center">
      ...
      <p className="mt-2 text-sm text-muted-foreground max-w-md leading-relaxed text-balance">
        We could not fetch your linked social media integrations. Please check your network connection and retry.
      </p>
