...
export default function DashboardError({
  ...
  return (
    <div className="flex min-h-[400px] flex-col items-center justify-center p-6 text-center">
      <div className="flex size-14 items-center justify-center rounded-full bg-destructive/10 text-destructive border border-destructive/20 mb-4 animate-bounce duration-[2000ms]">
      ...
      <p className="mt-2 text-sm text-muted-foreground max-w-md leading-relaxed text-balance">
        An error occurred while loading the dashboard metrics. This may be a temporary database connection issue.
      </p>
