...
export default function AutoReplyError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("Auto-reply error caught by boundary:", error);
  }, [error]);
  ...
  return (
    <div className="flex min-h-[400px] flex-col items-center justify-center p-6 text-center">
      ...
      <p className="mt-2 text-sm text-muted-foreground max-w-md leading-relaxed text-balance">
        We encountered an error loading your auto-comment response templates. Try refreshing.
      </p>
